...
# Source: https://github.com/enosair/bentkus_conf_seq/blob/master/conc_ineq/bentkus.py
# Kuchibhotla and Zhang, Near-Optimal Confidence Sequences for Bounded Random Variables
import numpy as np
import scipy.stats
import math
...
def bentkus(n, delta, A, B):
    """
        ...
        Input:
            ...
            A: the upper bound of the standard deviation of Xi.
